...
using MoveBangladesh.Application.TripRequests.Commands.AcceptTripRequest;
using MoveBangladesh.Application.TripRequests.Commands.CancelTripRequest;
using MoveBangladesh.Application.TripRequests.Commands.RejectByCustomer;
using MoveBangladesh.Application.TripRequests.Commands.RejectByDriver;
using MoveBangladesh.Application.TripRequests.Commands.TripRequests;
...
namespace MoveBangladesh.CustomerAPI.Controllers
{
	...
	public class TripRequestController : BaseController
	{
		...
		public async Task<ActionResult> AcceptTripRequest(string tripRequestId)
		{
			...
			var model = new AcceptTripRequestCommand(driverId, tripRequestId);
